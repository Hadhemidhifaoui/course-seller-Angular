...
export class TestComponent implements OnInit {
  ...
  updateSelectedOptions(event: any, suggestionId: any, questionId: any): void {
  ...
  updateSelectedOptionForRadio(suggestionId:any, questionId: any): void {
    const question = this.findQuestionById(questionId);
    if (question) {
      const suggestion = question.suggestions.find(suggestion => suggestion.id === suggestionId);
      if (suggestion) {
  ...
  submitAnswer(testId: any, questionId: any): void {
